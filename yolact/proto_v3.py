...
def video_detecting():
    ...
    playsound( "C:/Users/kjh/Desktop/yolact/alarm1.mp3" )
    str2 = "Safe :)"
    str3 = "We couldn't detect any keypoint"
    ...
    while True:                 # 무한 루프
        ...
        if len(body_point) == 0:
            cv2.putText(canvas, str3, (0, 300), cv2.FONT_HERSHEY_DUPLEX, 1.5, (0, 0, 0))
            ...
            for i in range(len(body_point)):
                ...
                if target_area[y][x] == 1:
                    cv2.putText(canvas, str2, (0, 300), cv2.FONT_HERSHEY_DUPLEX, 1.5, (0, 0, 0))
                else:
                    cv2.putText(canvas, str1, (0, 300), cv2.FONT_HERSHEY_DUPLEX, 1.5, (0, 0, 0))



        # cv2.putText(canvas, str, (0, 100), cv2.FONT_HERSHEY_DUPLEX, 1.5, (0, 255, 255))
